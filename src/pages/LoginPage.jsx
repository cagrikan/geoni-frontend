  ...
  return (
    <div className="login-page">
      <div className="login-card">
        ...
        <p className="login-sub">AI görünürlük raporlarınıza erişmek için devam edin</p>
        ...
        <p className="login-terms">
          Devam ederek <a href="https://geoni.ai/privacy" target="_blank">Gizlilik Politikası</a>'nı ve <a href="https://geoni.ai/terms" target="_blank">Kullanım Şartları</a>'nı kabul etmiş olursunuz.
        </p>
      </div>
    </div>
  )
